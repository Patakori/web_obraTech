...
export function Label({ text, className, htmlFor }: LabelProps) {
  return (
    <label
      htmlFor={htmlFor}
      className={twMerge(
        `z-20 duration-300 h-[] transform absolute font-inter font-bold text-sm text-primary-50 translate-x-[.4rem] peer-focus:scale-75 peer-focus:translate-y-[-.4rem] peer-focus:translate-x-[.4rem]
